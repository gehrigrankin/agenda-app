...
/** "Tasks" holds what the desktop rail's first panel stacks: the
 * meeting/plan/review card, the tasks widget (printed on the agenda's
 * lines), and the yesterday recap. */
