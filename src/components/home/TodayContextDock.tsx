  ...
  return (
    <>
      ...
      <nav
        ...
        className={`relative -mx-3 -mb-3 grid h-[3.25rem] w-[calc(100%+1.5rem)] flex-none grid-cols-3 gap-1 overflow-hidden border-t border-white/10 bg-black p-1 md:hidden ${open ? "z-30" : "z-20"}`}
      >
