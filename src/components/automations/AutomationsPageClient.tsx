...
function AutomationRow({
  ...
  return (
    <div
      ...
      className={`group rounded-xl border border-white/8 bg-white/2 px-[0.8125rem] py-[0.6875rem] ${
        ...
        <div className="overflow-hidden rounded-2xl border border-white/9 bg-panel/95">
          ...
          <div className="flex flex-col gap-[0.375rem] p-[0.625rem]">
            {loading ? (
              ...
              <div className="rounded-xl border border-white/8 bg-white/2 px-3 py-2.5 text-center text-[0.75rem] text-ink-600">
                No rules yet
              </div>
            ) : (
            ...
            {!loading &&
              (addingRule ? (
                ...
                <button
                  ...
                  className="flex items-center gap-[0.5625rem] rounded-xl px-[0.8125rem] py-2.5 text-left text-ink-600 hover:bg-white/3"
                >
