              ...
              {phase === "processing" ? (
                ...
                <>
                  {pendingTasks.map((t) => (
                    <div
                      key={t.key}
                      className="flex items-center gap-2 rounded-xl border border-sage/20 bg-sage/5 px-2.5 py-2"
                    >
                  ...
                  {pendingLinks.map((l) => (
                    <div
                      key={l.key}
                      className="flex items-center gap-2 rounded-xl border border-steel/22 bg-steel/5 px-2.5 py-2"
                    >
